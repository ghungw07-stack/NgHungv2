...
const BASE_DATA_PATH = path.resolve(process.cwd(), "src", "service-dqt","chat-zalo", "chat-special", "data-send");
const removedLinksDir = path.resolve(process.cwd(), "src", "service-dqt", "chat-zalo", "chat-special", "data-send", "removed-links");
